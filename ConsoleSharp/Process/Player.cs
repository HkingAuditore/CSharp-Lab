...
namespace ConsoleSharp.Process
{
    public class Player
    {
        ...
        public Player(string name, bool gender, int age)
        {
            Name = name;
            Gender = gender;
            Age = age;
        ...
        public Player(string name, bool gender, int attack,int defence, int age = _initAge)
        {
            Name = name;
            Gender = gender;
            Age = age;
        ...
        public int Attack(Player enemy)
        {
